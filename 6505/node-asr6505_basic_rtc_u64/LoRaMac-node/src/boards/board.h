...
//#define RADIOTXIRQ  GPIO_ResetBits(GPIOE, GPIO_Pin_6);   delay_1ms();  GPIO_SetBits(GPIOE, GPIO_Pin_6)
//#define RADIORXIRQ  GPIO_ResetBits(GPIOE, GPIO_Pin_7);   delay_1ms();  GPIO_SetBits(GPIOE, GPIO_Pin_7)
/*!
 * Board Version
 */
...
extern void Led_fun(void);
extern void led_lignt1s();
