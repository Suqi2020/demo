...
#include "linkwan.h"
#endif
//extern volatile int32_t RtcTimeOffset;  //有符号型  可正可负

#define      DR_TEST   2   //SUQI
   
#define CONFIG_SINGLE_CHANNEL//使用单通道
/*!
 ...
 */
#define MAX_ACK_RETRIES                             0//suqi  原来为8 重发机制
...
typedef enum eLoRaMacRxSlot
{
	...
	#ifdef CONFIG_LINKWAN_D2D
    /*!
     * LoRaMAC receive window 3 for class d
     */
    RX_SLOT_WIN_CLASS_D,
	#endif    
    /*!
...
typedef enum eLoRaMacMoteCmd
{
     ...
     * PreambleInfoReq
     */
    MOTE_MAC_PREAMBLE_INFO_REQ       = 0x80,    
	#endif
    MOTE_MAC_MAX_REQ
}LoRaMacMoteCmd_t;
...
typedef enum eLoRaMacSrvCmd
{
     ...
     * PreambleInfoAns
     */
    SRV_MAC_PREAMBLE_INFO_ANS        = 0x80,   
	#endif    
    SRV_MAC_MAX_ANS
}LoRaMacSrvCmd_t;
...
typedef union uPreambleInfo
{
    ...
    uint8_t Value;
    /*!
     * Structure containing the parameters for the PreambleInfoReq
     */
    struct sPreambleInfoFields
    {
        /*!
         * Periodicity = 0: period every 100ms
         * Periodicity = 15: period every 1600ms
         */
        uint8_t Periodicity     : 4;
        /*!
         * RFU
         */
        uint8_t RFU             : 4;
...
#ifdef CONFIG_LINKWAN_D2D
/*!
 * LoRaMAC MLME-Request for the preamble info service
 */
typedef struct sMlmeReqPreambleInfo
{
    PreambleInfo_t Period;
}MlmeReqPreambleInfo_t;
#endif
...
typedef struct sMlmeReq
{
    ...
    union uMlmeParam
    {
		...
		#ifdef CONFIG_LINKWAN_D2D
        /*!
         * MLME-Request parameters for a preamble info request
         */
        MlmeReqPreambleInfo_t PreambleInfo;        
		#endif        
...
typedef struct sMlmeConfirm
{
	...
	#ifdef CONFIG_LINKWAN_D2D
    /*!
     * PreambleInfoAns status
     */
    uint8_t PreambleStatus;
	#endif    
}MlmeConfirm_t;
...
typedef union uMibParam
{
     ...
     * preamble time in ms
     *
     * Related MIB type: \ref MIB_PREAMBLE_TIME
     */
...
{
    /*!
     * \brief   MCPS-Confirm primitive//链路层数据传输服务
     *
     ...
     *
     * \param   [OUT] MLME-Confirm parameters//管理服务 
     */
