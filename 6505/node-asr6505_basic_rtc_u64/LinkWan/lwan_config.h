...
REGION_CN470A
CONFIG_LINKWAN
CONFIG_DEBUG_LINKWAN
CONFIG_UART_DEBUG=1
CONFIG_SINGLE_CHANNEL
CONFIG_LINKWAN_D2D
*/
#define LORA_CONFIGS_MAGIC_NUM 0xCDCDCDCD
...
#define LWAN_DEV_CONFIG_DEFAULT {LORA_CONFIGS_MAGIC_NUM, {JOIN_MODE_OTAA, ULDL_MODE_INTER, WORK_MODE_NORMAL, CLASS_D}, \
                                 {LORAWAN_PREAMBLE_TIME},{1, 8, 8, JOIN_METHOD_DEF, 1, DR_5}, \
                                 0x0001, 0}//此处定义默认CLASSD
#else
//#define LWAN_DEV_CONFIG_DEFAULT {LORA_CONFIGS_MAGIC_NUM, {JOIN_MODE_OTAA, ULDL_MODE_INTER, WORK_MODE_NORMAL, CLASS_A}, \
                                 {1, 8, 8, JOIN_METHOD_DEF, 1, DR_5}, \
                                 0x0001, 0} 
#endif
#else
//#define LWAN_DEV_CONFIG_DEFAULT {LORA_CONFIGS_MAGIC_NUM, {JOIN_MODE_OTAA, ULDL_MODE_INTER, WORK_MODE_NORMAL, CLASS_A}, \
...
#ifdef CONFIG_SINGLE_CHANNEL
#define LWAN_MAC_CONFIG_DEFAULT {LORA_CONFIGS_MAGIC_NUM, {1, 1, 0, 1}, {7, 0}, 10, DR_5, 0, 0, {0, 0, 0}, 60, 0} 
#else
#define LWAN_MAC_CONFIG_DEFAULT {LORA_CONFIGS_MAGIC_NUM, {1, 1, 0, 1}, {7, 0}, 10, DR_3, 0, 0, {0, 0, 0}, 30, 0}
#endif

#ifdef CONFIG_LINKWAN_D2D
typedef struct eClassDParam {
    int16_t preambletime;
}  ClassDParam_t;
#endif
...
//LWAN_MAC_CONFIG_DEFAULT {LORA_CONFIGS_MAGIC_NUM, {1, 1, 0, 1}, {7, 0}, 10, DR_5, 0, 0, {0, 0, 0}, 30, 0} 
