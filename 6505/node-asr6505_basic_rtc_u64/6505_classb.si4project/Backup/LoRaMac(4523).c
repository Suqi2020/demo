...
static void OnRadioTxDone( void )
{
    ...
    LastTxSysTime.SubSeconds=TimerGetCurrentTime( Tick_ms)&0X3FF  ;  //范围0-999 PREDIV_S
#endif
...
//#ifdef  SUQI
                    ...
                    sysTimeCurrent.SubSeconds=TimerGetCurrentTime( Tick_ms)&0X3FFF;  //范围0-999
                    ...
                    currentTime = TimerGetCurrentTime(Tick_ms );
